  ...
  public: {
    Tables: {
      asaas_checkouts: {
        ...
        Relationships: [
          {
            foreignKeyName: "asaas_checkouts_office_id_fkey"
            columns: ["office_id"]
            isOneToOne: false
      ...
      asaas_webhooks: {
        ...
        Relationships: [
          {
            foreignKeyName: "asaas_webhooks_checkout_id_fkey"
            columns: ["checkout_id"]
            isOneToOne: false
            referencedRelation: "asaas_checkouts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "asaas_webhooks_checkout_id_fkey"
            columns: ["checkout_id"]
            isOneToOne: false
            referencedRelation: "checkout_dashboard"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      checkout_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "checkout_logs_checkout_id_fkey"
            columns: ["checkout_id"]
            isOneToOne: false
            referencedRelation: "asaas_checkouts"
            referencedColumns: ["id"]
