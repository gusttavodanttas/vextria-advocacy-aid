...
export const useUserRole = () => {
  const { user, isSuperAdmin, isAdmin, isOfficeAdmin, isFirstLogin, office, officeUser } = useAuth();
  ...
  return useMemo(() => {
    ...
    return {
      ...
      canViewAdminFeatures: isSuperAdmin,
  ...
  }, [user, isSuperAdmin, isAdmin, isOfficeAdmin, isFirstLogin, office, officeUser]);
};